...
(function(window, document) {
    ...
    function makeIdsUnique(svgElem, onlyReferenced) {
        ...
        if (idElements[_LENGTH_]) {
            ...
            for (tagName in iriTagNames) {
                (IRI_TAG_PROPERTIES_MAP[tagName] || [tagName])
                    .forEach(function(mappedProperty) {
    ...
    function createSVGInject(globalName, options) {
        ...
        if (IS_SVG_SUPPORTED) {
            ...
            addStyleToHead(
                'img[onload^="' + globalName + '("]{visibility:hidden;}'
            );
        }
                            ...
                            if (loadValue === LOAD_FAIL) {
                                ...
                                if (makeIdsUniqueOption) {
                                    if (hasUniqueIds === NULL) {
                                        ...
                                        svgElem = buildSvgElement(
                                            svgString,
                                            false
                                        );
                                        hasUniqueIds = makeIdsUnique(
                                            svgElem,
                                            false
                                        );
                                ...
                                svgElem =
                                    svgElem ||
                                    buildSvgElement(svgString, false);
                        ...
                        function(svgXml, svgString) {
                            ...
                            if (afterLoad) {
                                ...
                                if (svgElemOrSvgString) {
                                    ...
                                    var isString =
                                        typeof svgElemOrSvgString == "string";
                                    svgString = isString
                                        ? svgElemOrSvgString
                                        : svgElemToSvgString(svgElem);
                                    svgElem = isString
